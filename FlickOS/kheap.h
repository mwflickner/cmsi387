...
typedef struct
{
   ...
   uint32_t supervisor;     // Should extra pages requested by us be mapped as supervisor-only?
   uint32_t readonly;       // Should extra pages requested by us be mapped as read-only?
} heap_t;
